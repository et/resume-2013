...
\section{Experience}
\cventry{2011--2013}{Software Engineer}{Aspera}{Emeryville, CA}{}{Core developer on \emph{faspex}, a file exchange web application, provided for companies with sensitive data.}
...
\cvitem{Languages}{Ruby, Javascript, SQL, HTML, CSS, Haml, SCSS, C++, Tcl, Python, Java}
\cvitem{Backend}{Rails, Sinatra, Node.js}
\cvitem{Front-end}{AngularJS, Ember.js, Backbone.js, jQuery, jQuery UI, Bootstrap, Foundation}
\cvdoubleitem{Testing}{RSpec, Mocha, Cucumber}{Source Control}{Git, Subversion}
\cvdoubleitem{Databases}{MySQL, PostgreSQL, Redis}{Administration}{zsh, Apache, Nginx, Chef}
